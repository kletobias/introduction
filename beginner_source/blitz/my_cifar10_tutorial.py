...
trainloader = T.utils.data.DataLoader(train, batch_size=batch_size, shuffle=True,num_workers=10)
test = Tv.datasets.CIFAR10(root='data',train=False,download=True, transform=transform)
testloader = T.utils.data.DataLoader(test, batch_size=batch_size, shuffle=False, num_workers=10)
